export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f8] text-gray-900 scroll-smooth">
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-8 h-20 flex items-center justify-between">
          <a href="#discover" className="text-2xl font-extrabold">
            Creative<span className="bg-gradient-to-r from-pink-500 via-orange-400 to-teal-400 bg-clip-text text-transparent">Check</span>
          </a>
          ...
          <a href="#add-profile" className="bg-black text-white px-5 py-3 rounded-full text-sm font-semibold">
            + Add Your Profile
          </a>
        </div>
      </nav>

      <section id="discover" className="relative overflow-hidden px-8 py-24 text-center">
      ...
      <section id="categories" className="max-w-6xl mx-auto px-8 py-10">
        <div className="flex flex-wrap justify-center gap-4">
          {[
            ...
            <span key={item} className="bg-white rounded-full px-5 py-3 shadow text-sm font-semibold">
              {item}
            </span>
          ))}
        </div>
      ...
      <section id="studios" className="max-w-7xl mx-auto px-8 py-20">
        <div className="mb-10">
          <h2 className="text-4xl font-extrabold">Explore the Creative World</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {profiles.map((profile) => (
            <div key={profile.name} className="bg-white rounded-3xl shadow-xl p-6 border border-gray-100">
      ...
      <section id="resources" className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            <div key={title} className="bg-white rounded-3xl shadow p-6">
      ...
      <footer id="about" className="max-w-7xl mx-auto px-8 py-12 text-sm text-gray-500">
