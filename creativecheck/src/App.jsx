  ...
  return <div className="cc-site">
    ...
    <main>
      <section id="discover" className="cc-hero-premium">
        ...
        <div className="cc-hero-art-premium"><div className="hero-word hero-word-a">CREATE</div><div className="hero-word hero-word-b">CONNECT</div><div className="hero-ring ring-a"/><div className="hero-ring ring-b"/><div className="hero-art-note">For the people<br/>behind the work.</div></div>
      </section>
