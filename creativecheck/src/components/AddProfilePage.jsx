    ...
    <section id="add-profile" className="max-w-3xl mx-auto px-8 py-24">
      <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100">
        ...
        <p className="text-xs text-gray-400 mb-10 leading-relaxed">
          By submitting, you confirm that the information provided is public-facing professional information.
          CreativeCheck may review submissions before publishing.
        </p>
