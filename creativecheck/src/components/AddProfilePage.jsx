...
function ProfileForm({ isBusiness }) {
  ...
  async function handleSubmit(e) {
    ...
    const profileData = {
      ...
      bio: form.bio.value,
      profile_type: isBusiness ? 'business' : 'creative',
      status: 'pending',
      verified: false
    }
      ...
      <section className="max-w-4xl mx-auto px-8 py-14">
        <div className="rounded-[36px] bg-white/80 backdrop-blur-xl border border-white/80 shadow-[0_20px_60px_rgba(15,23,42,0.08)] p-8 md:p-10">
          <div className="mb-10">
            ...
            <h2 className="text-4xl md:text-5xl font-black tracking-[-3px] text-[#0f172a] leading-[1]">Create your {isBusiness ? 'Creative Business' : 'Creative'} profile</h2>
            <p className="mt-5 text-[16px] text-gray-500 leading-relaxed max-w-2xl">{isBusiness ? 'Tell the creative community who your business is, what it does and how people can find you.' : 'Tell the creative community who you are, what you do and where people can find your work.'}</p>
          </div>
