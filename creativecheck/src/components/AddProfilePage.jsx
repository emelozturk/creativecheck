...
export default function AddProfilePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage('Profile submitted successfully. It will be reviewed before publishing.')
        form.reset()
    ...
    <section id="add-profile" className="max-w-3xl mx-auto px-8 py-24">
      <div className="bg-white rounded-3xl shadow-xl p-10 border border-gray-100 text-center">
        ...
        <p className="text-gray-500 mb-8">
          Submit your public creative profile for review before it appears on CreativeCheck.
        </p>
          ...
          <div className="w-full max-w-2xl rounded-3xl bg-white p-8 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="grid gap-5">
              ...
              <label className="flex gap-3 text-xs text-gray-500 leading-relaxed">
                ...
                I confirm that the information submitted is accurate, belongs to me, and may be reviewed by CreativeCheck before publication.
              </label>
