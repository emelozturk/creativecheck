  ...
  return (
    <div className="max-w-[780px] mx-auto px-6 mt-6 mb-8">
      <div className="flex items-center bg-white rounded-full px-6 py-2"
           style={{ boxShadow: '0 4px 40px rgba(0,0,0,0.11), 0 1px 8px rgba(124,58,237,0.08)' }}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9ca3af"
             strokeWidth="2.2" strokeLinecap="round" className="flex-shrink-0 mr-3">
        ...
        <button
          ...
          style={{ background: '#7c3aed', boxShadow: '0 4px 18px rgba(124,58,237,0.4)' }}>
